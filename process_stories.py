...
def process_story_pair(destination, long_story_filename = None, short_story_filename = None, min_stops_for_long_story = 1):
    ...
    # this function formats a list of cues into a single string of kotlin code, after replacing double quote-marks with single quote-marks.
    ...
    def format_list_of_cues(list_of_cues):
        list_of_indented_and_quoted_cues = [f"    \"{swap_quote_marks(cue_string)}\"" for cue_string in list_of_cues]
