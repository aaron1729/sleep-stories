...
// REPLACED_SENTENCES:
// 
// OLD SENTENCE: With the gentle whisper of the Prius coming to a halt, we step out, greeted by the studious hum of university life that emanates from the historic grounds of UC Berkeley
// NEW SENTENCE: With the gentle whisper of the Prius coming to a halt, we step out, greeted by the studious hum of university life that emanates from the historic grounds of UC Berkeley. The sun bathes the campus in a light, illuminating the vibrant academic atmosphere and revealing the impressive Berkeley architect
// 
// OLD SENTENCE: Emerging from the verdant embrace of Tilden Park, our hybrid carriage now whisks us toward César Chávez Park, a reclaimed expanse of natural splendor sitting beside the gentle lapping waters of the San Francisco Bay
// NEW SENTENCE: Emerging from the verdant embrace of Tilden Park, our hybrid carriage now whisks us toward César Chávez Park, a reclaimed expanse of natural splendor sitting beside the gentle lapping waters of the San Francisco Bay. The 
// 
// OLD SENTENCE:  The park, crafted from the remnants of the Berkeley Municipal Landfill in the early nineties, stands as a proud legacy to the Latino American civil rights leader and labor movement activist, César Chávez
// NEW SENTENCE:  Bay. The park, crafted from the remnants of the Berkeley Municipal Landfill in the early nineteen nineties, stands as a proud legacy to the Latino American civil rights leader and labor movement activist, César Chávez.
// 
// OLD SENTENCE: 
// 
// *****
// 
// Steering away from the carefree atmosphere of César Chávez Park, our gentle journey guides us to the dynamic and picturesque Berkeley Marina
// NEW SENTENCE: Steering away from the carefree atmosphere of César Chávez Park, our gentle journey guides us to the dynamic and picturesque Berkeley Marina. Once a c
// 
// OLD SENTENCE: 
// 
// Designed by the renowned firm Diller Scofidio + Renfro and unveiled in 2016, this space stands as a beacon of artistic innovation, housing over nineteen thousand art pieces and seventeen thousand five hundred films and videos
// NEW SENTENCE: Designed by the renowned firm Diller Scofidio + Renfro and unveiled in twenty sixteen, this space stands as a beacon of artistic innovation, housing over nineteen thousand art pieces and seventeen thousand five hundred films and videos. It is a 
// 
// OLD SENTENCE: 
// 
// It is not uncommon to find oneself momentarily rooted to the spot outside, mesmerized by the dynamic LED facade of BAMPFA, which illuminates the surrounding area with digital art corresponding to the treasures held within
// NEW SENTENCE: It is not uncommon to find oneself momentarily rooted to the spot outside, mesmerized by the dynamic LED facade of BAMPFA, which illuminates the surrounding area with digital art corresponding to the treasures held within. As the d

// LONG STORY REPLACED SENTENCES:
// 
// REPLACED_SENTENCES:
// 
// OLD SENTENCE:  Often simply referred to as UC Berkeley, the university was founded in the year eighteen sixty-eight, making it the oldest campus in the University of California system
// NEW SENTENCE: Berkeley. Often simply referred to as UC Berkeley, the university was founded in the year eighteen sixty-eight, making it the oldest campus in the University of California system. Its rich
// 
// OLD SENTENCE:  We glide away from the UC Berkeley campus in our Prius, the car moving silently between the avenues of academia and innovation
// NEW SENTENCE:  city. We glide away from the UC Berkeley campus in our Prius, the car moving silently between the avenues of academia and innovation. The spri
// 
// OLD SENTENCE:  From the riotous color of the Berkeley Rose Garden to the architectural splendor and scholarly ambiance of the UC Berkeley campus, each location has woven into our senses a tapestry of peaceful contemplation and appreciation for both natural splendor and human achievement
// NEW SENTENCE: ollected. From the riotous color of the Berkeley Rose Garden to the architectural splendor and scholarly ambiance of the UC Berkeley campus, each location has woven into our senses a tapestry of peaceful contemplation and appreciation for both natural splendor and human achievement.
...
object SleepStoryTravelBerkeleyCues : SleepStoryPoseCues {
  ...
  override val startShort =
    "As the gentle breeze tousles the newborn leaves on the trees, we prepare for a serene exploration of Berkeley, California in the tender embrace of spring. The scent of blossoming flowers dances through the air, mingling with the faint whispers of a vibrant city waking up to the promise of a new season." /
    "The touch of the sun feels soothing on the skin, coaxing the world into a state of fresh, calm renewal. Today, we are not merely visitors, but participants in a tranquil journey in a Prius, our trusted hybrid chariot, designed to glide through the streets with a quiet hum - a testament to the city's embrace of eco-conscious living." /
    "There's something inherently promising about venturing into Berkeley with its fusion of academic prowess and bohemian charm. As we anticipate our sightseeing tour, the imagination begins to wander." /
    "We envision students and scholars meandering through leafy college paths, lively discussions spilling out of cozy cafés, and open-minded locals engaging in exchanges that spark innovation. The town wears its heart on its sleeve: a patchwork of global cultures, bound by a unifying spirit of community and a passion for sustainability." /
    "Our Prius tour will crisscross the city's eclectic neighborhoods, but we'll also relish the chance to stretch our legs, walk around, and blend into the local rhythm. Feel the pulse of Berkeley's heritage as we tread lightly upon its historic streets, absorb the artistic energy, and share smiles with the warm-hearted people going about their day, each step a soothing pause in reality." /
    "Before we set out on our personalized exploration, we'll first aim our compass toward a place with a history as rich as its flora – the Berkeley Rose Garden. In this city of intellectual and cultural treasures, the garden stands out as a living, breathing ode to nature's artistry, enveloped in the sweet, luscious scent of a thousand roses." /
    "Our hearts thrum with excitement, and a sense of peaceful anticipation settles in as we prepare to see, smell, and be enraptured by the splendor that awaits. The tour promises to be a soothing reverie, a harmonious symphony composed of Berkeley's unique urban tempo and nature’s tranquil melody." /
    "Let us begin our journey, where every sight and sound whispers tales of beauty and repose."

  override val middleShort = listOf(
    "With the gentle whisper of the Prius coming to a halt, we step out, greeted by the studious hum of university life that emanates from the historic grounds of UC Berkeley. The sun bathes the campus in a light, illuminating the vibrant academic atmosphere and revealing the impressive Berkeley architecture to our eager eyes." /
    "This prestigious institution, founded in eighteen sixty-eight, is imbued with the spirit of inquiry and knowledge that has flowed through generations." /
    "We walk along the tree-lined pathways where the bright minds of yesterday and today converge. Our guide leads us to the foot of the majestic Sather Tower, the Campanile, one of the tallest bell and clock-towers globally." /
    "Its presence looms kindly over the campus, an ever-watchful guardian of both past and present. Here, the echoes of the Free Speech Movement of the nineteen sixties seem to resonate within its stones, reminding us of the university's historic commitment to activism and change." /
    "Our eyes roam across the crowds of students and visitors who weave their stories into the fabric of the campus. They stretch out on the lush grass of Memorial Glade, absorbed in their books or simply soaking in the peace offered by the azure canvas above, punctuated only by the Campanile’s silhouette." /
    "In this environment, thriving with intellectual vitality, twenty-two Nobel laureates have found a home as alumni or faculty, a legacy that enriches the air we breathe with excellence and achievement." /
    ...
    "Named after Charles Lee Tilden, a Bay Area attorney, and businessman with vision and dedication to public space, this grand oasis spans over two thousand acres of untamed hills and reflective trails. Senses awaken to the sheer variety of amenities that await exploration." /
    "We catch the nostalgia-tinged chug of a steam train, a playful nod to bygone times, and the promise of discovery at the environmental education center." /
    "But it's the Tilden Botanic Garden that beckons us with its devoted display of Californian-native plants. Our footfalls are soft among the pathways enveloped by the garden's lush offerings." /
    "We pause to admire the native wildflowers’ vibrant hues, their scent fresh upon the breeze that caresses our cheeks. The quiet is profound, punctuated only by the whispering of tall grasses and the burble of a nearby brook." /
    "We indulge in this untouched corner of the park, where the pace of our breath aligns with the slow unfurling of ferns and the leisurely flight of butterflies." /
    ...
    "The salty scent of the sea mingles with the earthier notes rising from the grass, and the playful cries of joy from kite flyers punctuate the quiet." /
    ...
    "Steering away from the carefree atmosphere of César Chávez Park, our gentle journey guides us to the dynamic and picturesque Berkeley Marina. Once a city dump site, reclaimed in the nineteen sixties, the marina now serves as a beacon of coastal leisure and nautical adventure." /
    "As part of the Eastshore State Park, it boasts an impressive eight and a half miles of pristine shoreline to explore." /
    "The marina is a haven for over one thousand boats and yachts, their masts raised like a forest of wooden spires that salute the open sky. The annual Berkeley Kite Festival here transforms the sky into a canvas of whimsical motion and vibrant colors." /
    "On the winding docks, individuals and families stroll, some clasping the leashes of delighted dogs while others prepare to navigate the waters, kayaks and sails at the ready." /
    "One can find respite upon a bench, where the spectacle of the sunset unfolds in a display of radiant warmth across the bay. The water glitters, a moving mirror of the sky's changing palette, while the soundscape is filled with the soft clinking of ropes against masts, a natural melody that serenades the marina's visitors." /
    "It is here, amidst the blend of earth and water, activity and leisure, that the intrinsic beauty of Berkeley's shoreline fully reveals itself."
)
  ...
  override val endShort =
    ...
    "Our exploration of Berkeley concludes amid the peaceful sighs of the Prius's engine, a lullaby that has accompanied us from lush gardens to vibrant campuses, from waterfront retreats to the dwelling of muses that is BAMPFA. A satisfying stillness settles in our hearts, like the final, lingering note of a cherished melody." /
    "As night begins to weave its gentle shroud over the city, we take solace in the memories created from the sights we've seen, the aromas savored, and the harmonies heard." /
  ...
  override val start =
    "Nestled on the eastern shore of San Francisco Bay, Berkeley, California unfolds before us - a vibrant tapestry of culture, academia, and natural beauty. It's springtime here, and the city is awakening with a renewed energy, the air lightly scented with blooming flowers, the mild climate providing a perpetual embrace." /
    "We savor the anticipation of discovery as we prepare to embark on our sightseeing tour through this storied cityscape and its lush surroundings, all the while comforted by our environmentally conscious choice of transportation, a whisper-quiet Prius." /
    "Our journey promises a blend of intellectual charm and scenic wonder, a gentle adventure through winding streets steeped in history and innovation. As we plan our route, we imagine the sunlight dappling through the fresh leaves of sycamores and oaks, intermingling with the sounds of distant laughter and the hum of student life from the University of California, Berkeley, the city's beating heart." /
    "The scent of nearby cafés, where intellectual debates percolate alongside artisanal coffee, seems to draw us forward." /
    "We envisage conversations with friendly locals, our thoughts dancing to the rhythm of the city, our path unfolding with serendipitous turns and inspiring views. This hybrid car glides softly through Berkeley's vibrant districts, promising an afternoon exploring an urban sanctuary where community and nature coexist harmoniously." /
    "We look forward to a tour rich with the sights of spring—a vision of greenery, innovation, and peaceful exploration in the California sun."

  override val middle = listOf(
    "As we exit our Prius, a gentle breeze greets us, carrying the soft, sweet scent of roses. The Berkeley Rose Garden lies before us like a living watercolor painting, brimming with the bright and soothing hues of over two hundred and fifty varieties of roses." /
    "Approximately one thousand five hundred rose bushes bloom in profusion, abuzz with the quiet industry of bees that flit from petal to petal. Constructed in the nineteen thirties under the Works Progress Administration, this verdant sanctuary has offered solace and delight to visitors since its opening in nineteen thirty-seven." /
    "We wander along its well-kept paths, pausing to admire the delicate petals arrayed in a kaleidoscope of color, each bush an individual masterpiece, the result of careful tending and nurturing. The murmuring of fellow visitors serenades us as they, too, meander through the paths, cameras in hand, capturing snapshots of nature's unassuming beauty." /
    "Occasionally, we overhear soft exclamations of wonder as someone discovers a particularly stunning bloom." /
    "Drawn to the garden's architectural highlight, we find a seat beneath the stately redwood pergola, a striking structure that stands guard over the roses. We settle comfortably on a bench and take a moment to simply breathe and be present, enveloped in the velvety aroma of roses, each breath deep with floral notes." /
    "Our eyes then drift to the amphitheater, terraced and welcoming, a natural auditorium for the performances it occasionally hosts." /
    "For now, though, it's the panoramic spectacle unfurling beyond the roses that captures our reverie. Dusky light bathes the San Francisco Bay, the setting sun wrapping the skyline in a warm, golden embrace." /
    "The glow of the departing day enhances the vibrant spectacle of the rose garden, the color of each flower deepened and enriched by the sunset's tender caress. This quiet moment under the pergola allows the soul to soak in the timeless dance of light and life, a soothing balm to the hectic pace of the world beyond these garden walls."
)

  override val end =
    "Our sightseeing tour continues as we make our way towards the storied grounds of the University of California, Berkeley. Often simply referred to as UC Berkeley, the university was founded in the year eighteen sixty-eight, making it the oldest campus in the University of California system." /
    "Its rich history and prestigious reputation are palpable in the very air we breathe as we step onto the campus." /
    "We are drawn towards the towering presence of Sather Tower, the Campanile, which stretches skyward in an impressive display of architectural ambition. Not only is it one of the tallest bell and clock-towers in the world, but its chimes resonate with the history of countless students who have passed beneath it." /
    "We join the flow of visitors craning their necks for a better view of the Campanile, its silhouette a proud fixture against the Californian sky." /
    "As we stroll across the campus, we become part of the vibrant academic atmosphere that has ignited minds and passions for generations. Here is where voices for change rose to prominence during the Free Speech Movement in the nineteen sixties, a legacy that shimmers in the background as students engage in lively debate on the green lawns." /
    "With twenty-two Nobel laureates once walking these pathways as either faculty or alumni, inspiration seems to linger on the breeze, urging us to dream a little bigger." /
    ...
    "On the sunlit expanse of the Memorial Glade, students and visitors are dotted across the grass, some sprawled with books open, others chatting and picnicking. The scene is one of careful harmony, where academic pursuit and relaxation meet, all framed by the comforting sight of the Campanile under a vault of clear, blue sky." /
    "It's a canvas of living art, inviting everyone to paint their own experience within its generous borders." /
    "Our journey through Berkeley, California, reaches a gentle conclusion, our hearts and minds filled with the serene beauty and intellectual vigor of this unique city. We glide away from the UC Berkeley campus in our Prius, the car moving silently between the avenues of academia and innovation." /
    "The spring air, still carrying the exuberance of the day, flows through slightly lowered windows, enriching the atmosphere within our eco-friendly cocoon with the musky scent of earth brought to life by seasonal rains and the subtle fragrances of newly sprouted leaves." /
    ...
    "With hearts aglow with the enduring light of our Berkeley springtime tour, we carry forward the inspiration, ready to unfold the next chapter of our own stories."
